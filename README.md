...
| <a name="input_admission_controller_irsa_assume_role_enabled"></a> [admission\_controller\_irsa\_assume\_role\_enabled](#input\_admission\_controller\_irsa\_assume\_role\_enabled) | Whether IRSA for the Kyverno Admission Controller component is allowed to assume role defined by `admission_controller_irsa_assume_role_arn`. Mutually exclusive with `admission_controller_irsa_policy_enabled`. | `bool` |
| <a name="input_admission_controller_irsa_permissions_boundary"></a> [admission\_controller\_irsa\_permissions\_boundary](#input\_admission\_controller\_irsa\_permissions\_boundary) | ARN of the policy that is used to set the permissions boundary for the IRSA role of the Kyverno Admission Controller component. Defaults to `""`. | `string` |
| <a name="input_admission_controller_irsa_policy"></a> [admission\_controller\_irsa\_policy](#input\_admission\_controller\_irsa\_policy) | Policy to be attached to the default role of the Kyverno Admission Controller component. Applied only if `admission_controller_irsa_policy_enabled` is `true`. | `string` |
| <a name="input_admission_controller_irsa_policy_enabled"></a> [admission\_controller\_irsa\_policy\_enabled](#input\_admission\_controller\_irsa\_policy\_enabled) | Whether to create IAM policy specified by `admission_controller_irsa_policy` for the Kyverno Admission Controller component. Mutually exclusive with `admission_controller_irsa_assume_role_enabled`. | `bool` |
| <a name="input_admission_controller_irsa_role_create"></a> [admission\_controller\_irsa\_role\_create](#input\_admission\_controller\_irsa\_role\_create) | Whether to create the IRSA role for the Kyverno Admission Controller component. | `bool` |
| <a name="input_admission_controller_irsa_role_name"></a> [admission\_controller\_irsa\_role\_name](#input\_admission\_controller\_irsa\_role\_name) | The name of the IRSA role for the Kyverno Admission Controller component. | `string` |
| <a name="input_admission_controller_rbac_create"></a> [admission\_controller\_rbac\_create](#input\_admission\_controller\_rbac\_create) | Whether to create and use Admission Controller RBAC resources. | `bool` |
| <a name="input_admission_controller_service_account_create"></a> [admission\_controller\_service\_account\_create](#input\_admission\_controller\_service\_account\_create) | Whether to create the Service Account for the Kyverno Admission Controller component. | `bool` |
| <a name="input_admission_controller_service_account_name"></a> [admission\_controller\_service\_account\_name](#input\_admission\_controller\_service\_account\_name) | The name of the Service Account for the Kyverno Admission Controller component. | `string` |
...
| <a name="input_background_controller_enabled"></a> [background\_controller\_enabled](#input\_background\_controller\_enabled) | Set to true to enable Thanos Query component | `bool` |
| <a name="input_background_controller_irsa_additional_policies"></a> [background\_controller\_irsa\_additional\_policies](#input\_background\_controller\_irsa\_additional\_policies) | Map of the additional policies to be attached to default role of the Kyverno Background Controller component. Where key is arbitrary id and value is policy ARN. | `map(string)` |
| <a name="input_background_controller_irsa_assume_role_arns"></a> [background\_controller\_irsa\_assume\_role\_arns](#input\_background\_controller\_irsa\_assume\_role\_arns) | Assume role ARNs for the Kyverno Background Controller component. Applied only if `background_controller_irsa_assume_role_enabled` is `true`. | `list(string)` |
| <a name="input_background_controller_irsa_assume_role_enabled"></a> [background\_controller\_irsa\_assume\_role\_enabled](#input\_background\_controller\_irsa\_assume\_role\_enabled) | Whether IRSA for the Kyverno Background Controller component is allowed to assume role defined by `background_controller_irsa_assume_role_arn`. Mutually exclusive with `background_controller_irsa_policy_enabled`. | `bool` |
| <a name="input_background_controller_irsa_permissions_boundary"></a> [background\_controller\_irsa\_permissions\_boundary](#input\_background\_controller\_irsa\_permissions\_boundary) | ARN of the policy that is used to set the permissions boundary for the IRSA role of the Kyverno Background Controller component. Defaults to `""`. | `string` |
| <a name="input_background_controller_irsa_policy"></a> [background\_controller\_irsa\_policy](#input\_background\_controller\_irsa\_policy) | Policy to be attached to the default role of the Kyverno Background Controller component. Applied only if `background_controller_irsa_policy_enabled` is `true`. | `string` |
| <a name="input_background_controller_irsa_policy_enabled"></a> [background\_controller\_irsa\_policy\_enabled](#input\_background\_controller\_irsa\_policy\_enabled) | Whether to create IAM policy specified by `background_controller_irsa_policy` for the Kyverno Background Controller component. Mutually exclusive with `background_controller_irsa_assume_role_enabled`. | `bool` |
| <a name="input_background_controller_irsa_role_create"></a> [background\_controller\_irsa\_role\_create](#input\_background\_controller\_irsa\_role\_create) | Whether to create the IRSA role for the Kyverno Background Controller component. | `bool` |
| <a name="input_background_controller_irsa_role_name"></a> [background\_controller\_irsa\_role\_name](#input\_background\_controller\_irsa\_role\_name) | The name of the IRSA role for the Kyverno Background Controller component. | `string` |
| <a name="input_background_controller_rbac_create"></a> [background\_controller\_rbac\_create](#input\_background\_controller\_rbac\_create) | Whether to create and use Background Controller RBAC resources. | `bool` |
| <a name="input_background_controller_service_account_create"></a> [background\_controller\_service\_account\_create](#input\_background\_controller\_service\_account\_create) | Whether to create the Service Account for the Kyverno Background Controller component. | `bool` |
| <a name="input_background_controller_service_account_name"></a> [background\_controller\_service\_account\_name](#input\_background\_controller\_service\_account\_name) | The name of the Service Account for the Kyverno Background Controller component. | `string` |
| <a name="input_cleanup_controller_enabled"></a> [cleanup\_controller\_enabled](#input\_cleanup\_controller\_enabled) | Set to true to enable Thanos Query component | `bool` |
| <a name="input_cleanup_controller_irsa_additional_policies"></a> [cleanup\_controller\_irsa\_additional\_policies](#input\_cleanup\_controller\_irsa\_additional\_policies) | Map of the additional policies to be attached to default role of the Kyverno Cleanup Controller component. Where key is arbitrary id and value is policy ARN. | `map(string)` |
| <a name="input_cleanup_controller_irsa_assume_role_arns"></a> [cleanup\_controller\_irsa\_assume\_role\_arns](#input\_cleanup\_controller\_irsa\_assume\_role\_arns) | Assume role ARNs for the Kyverno Cleanup Controller component. Applied only if `cleanup_controller_irsa_assume_role_enabled` is `true`. | `list(string)` |
| <a name="input_cleanup_controller_irsa_assume_role_enabled"></a> [cleanup\_controller\_irsa\_assume\_role\_enabled](#input\_cleanup\_controller\_irsa\_assume\_role\_enabled) | Whether IRSA for the Kyverno Cleanup Controller component is allowed to assume role defined by `cleanup_controller_irsa_assume_role_arn`. Mutually exclusive with `cleanup_controller_irsa_policy_enabled`. | `bool` |
| <a name="input_cleanup_controller_irsa_permissions_boundary"></a> [cleanup\_controller\_irsa\_permissions\_boundary](#input\_cleanup\_controller\_irsa\_permissions\_boundary) | ARN of the policy that is used to set the permissions boundary for the IRSA role of the Kyverno Cleanup Controller component. Defaults to `""`. | `string` |
| <a name="input_cleanup_controller_irsa_policy"></a> [cleanup\_controller\_irsa\_policy](#input\_cleanup\_controller\_irsa\_policy) | Policy to be attached to the default role of the Kyverno Cleanup Controller component. Applied only if `cleanup_controller_irsa_policy_enabled` is `true`. | `string` |
| <a name="input_cleanup_controller_irsa_policy_enabled"></a> [cleanup\_controller\_irsa\_policy\_enabled](#input\_cleanup\_controller\_irsa\_policy\_enabled) | Whether to create IAM policy specified by `cleanup_controller_irsa_policy` for the Kyverno Cleanup Controller component. Mutually exclusive with `cleanup_controller_irsa_assume_role_enabled`. | `bool` |
| <a name="input_cleanup_controller_irsa_role_create"></a> [cleanup\_controller\_irsa\_role\_create](#input\_cleanup\_controller\_irsa\_role\_create) | Whether to create the IRSA role for the Kyverno Cleanup Controller component. | `bool` |
| <a name="input_cleanup_controller_irsa_role_name"></a> [cleanup\_controller\_irsa\_role\_name](#input\_cleanup\_controller\_irsa\_role\_name) | The name of the IRSA role for the Kyverno Cleanup Controller component. | `string` |
| <a name="input_cleanup_controller_rbac_create"></a> [cleanup\_controller\_rbac\_create](#input\_cleanup\_controller\_rbac\_create) | Whether to create and use Cleanup Controller RBAC resources. | `bool` |
| <a name="input_cleanup_controller_service_account_create"></a> [cleanup\_controller\_service\_account\_create](#input\_cleanup\_controller\_service\_account\_create) | Whether to create the Service Account for the Kyverno Cleanup Controller component. | `bool` |
| <a name="input_cleanup_controller_service_account_name"></a> [cleanup\_controller\_service\_account\_name](#input\_cleanup\_controller\_service\_account\_name) | The name of the Service Account for the Kyverno Cleanup Controller component. | `string` |
...
| <a name="input_reports_controller_enabled"></a> [reports\_controller\_enabled](#input\_reports\_controller\_enabled) | Set to true to enable Thanos Query component | `bool` |
| <a name="input_reports_controller_irsa_additional_policies"></a> [reports\_controller\_irsa\_additional\_policies](#input\_reports\_controller\_irsa\_additional\_policies) | Map of the additional policies to be attached to default role of the Kyverno Reports Controller component. Where key is arbitrary id and value is policy ARN. | `map(string)` |
| <a name="input_reports_controller_irsa_assume_role_arns"></a> [reports\_controller\_irsa\_assume\_role\_arns](#input\_reports\_controller\_irsa\_assume\_role\_arns) | Assume role ARNs for the Kyverno Reports Controller component. Applied only if `reports_controller_irsa_assume_role_enabled` is `true`. | `list(string)` |
| <a name="input_reports_controller_irsa_assume_role_enabled"></a> [reports\_controller\_irsa\_assume\_role\_enabled](#input\_reports\_controller\_irsa\_assume\_role\_enabled) | Whether IRSA for the Kyverno Reports Controller component is allowed to assume role defined by `reports_controller_irsa_assume_role_arn`. Mutually exclusive with `reports_controller_irsa_policy_enabled`. | `bool` |
| <a name="input_reports_controller_irsa_permissions_boundary"></a> [reports\_controller\_irsa\_permissions\_boundary](#input\_reports\_controller\_irsa\_permissions\_boundary) | ARN of the policy that is used to set the permissions boundary for the IRSA role of the Kyverno Reports Controller component. Defaults to `""`. | `string` |
| <a name="input_reports_controller_irsa_policy"></a> [reports\_controller\_irsa\_policy](#input\_reports\_controller\_irsa\_policy) | Policy to be attached to the default role of the Kyverno Reports Controller component. Applied only if `reports_controller_irsa_policy_enabled` is `true`. | `string` |
| <a name="input_reports_controller_irsa_policy_enabled"></a> [reports\_controller\_irsa\_policy\_enabled](#input\_reports\_controller\_irsa\_policy\_enabled) | Whether to create IAM policy specified by `reports_controller_irsa_policy` for the Kyverno Reports Controller component. Mutually exclusive with `reports_controller_irsa_assume_role_enabled`. | `bool` |
| <a name="input_reports_controller_irsa_role_create"></a> [reports\_controller\_irsa\_role\_create](#input\_reports\_controller\_irsa\_role\_create) | Whether to create the IRSA role for the Kyverno Reports Controller component. | `bool` |
| <a name="input_reports_controller_irsa_role_name"></a> [reports\_controller\_irsa\_role\_name](#input\_reports\_controller\_irsa\_role\_name) | The name of the IRSA role for the Kyverno Reports Controller component. | `string` |
| <a name="input_reports_controller_rbac_create"></a> [reports\_controller\_rbac\_create](#input\_reports\_controller\_rbac\_create) | Whether to create and use Reports Controller RBAC resources. | `bool` |
| <a name="input_reports_controller_service_account_create"></a> [reports\_controller\_service\_account\_create](#input\_reports\_controller\_service\_account\_create) | Whether to create the Service Account for the Kyverno Reports Controller component. | `bool` |
| <a name="input_reports_controller_service_account_name"></a> [reports\_controller\_service\_account\_name](#input\_reports\_controller\_service\_account\_name) | The name of the Service Account for the Kyverno Reports Controller component. | `string` |
